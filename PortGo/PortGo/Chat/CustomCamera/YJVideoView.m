...
- (UILabel *)hintTitleLB {
    if (!_hintTitleLB) {
        _hintTitleLB = [UIUtility initLabelWithText:NSLocalizedString(@"Photo_tip", @"Photo_tip") fontSize:FontSize15 color:APP_WHITE textAlignment:NSTextAlignmentCenter];
    }
    return _hintTitleLB;
}
