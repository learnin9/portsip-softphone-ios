...
- (void)traitCollectionDidChange:(UITraitCollection *)previousTraitCollection{
    ...
    self.bottomScrollableSegment.backgroundColor = inputbkColor;
    if(_sendButton!=nil){
        [_sendButton setBackgroundColor:inputbkColor];
    }
    [self setBackgroundColor:inputbkColor];
    self.backgroundColor = inputbkColor;
    if(self.stickerCoverButtons!=nil){
        for(PPSlideLineButton* button in self.stickerCoverButtons){
            [button setBackgroundColor:inputbkColor];
        }
    }
}
