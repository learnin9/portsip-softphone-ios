...
- (JRDBChain *(^)(id param))eq {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_Equal;
        return self.chain;
    };
}
...
- (JRDBChain *(^)(id param))nq  {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_NotEqual;
        return self.chain;
    };
}
...
- (JRDBChain *(^)(id param))like {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_Like;
        return self.chain;
    };
}
...
- (JRDBChain * _Nonnull (^)(id _Nonnull))gt {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_GreaterThan;
        return self.chain;
    };
}
...
- (JRDBChain * _Nonnull (^)(id _Nonnull))gtOrEq {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_GreaterThanOrEqual;
        return self.chain;
    };
}
...
- (JRDBChain * _Nonnull (^)(id _Nonnull))lt {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_LessThan;
        return self.chain;
    };
}
...
- (JRDBChain * _Nonnull (^)(id _Nonnull))ltOrEq {
    return ^JRDBChain *(id param) {
        self->_param = param;
        self->_operatorer = JRDBChainConditionOperator_LessThanOrEqual;
        return self.chain;
    };
}
